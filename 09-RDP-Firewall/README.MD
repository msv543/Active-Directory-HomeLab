...
1. Configured a Firewall Baseline (GPO) with the following settings:
...
2. Linked the Firewall Baseline GPO to the Workstations Organizational Unit containing domain workstations.
